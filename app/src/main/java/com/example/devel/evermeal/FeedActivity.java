...
import com.example.devel.evermeal.Widget.cmtlistview.adapter.CommentListAdapter;
import com.example.devel.evermeal.Widget.cmtlistview.data.CommentItem;
import com.example.devel.evermeal.Widget.cmtlistview.data.CommentItemDescComparator;
...
import com.example.devel.evermeal.gcm.MyGcmListenerService;
import com.example.devel.evermeal.gcm.OnGcmMessageListener;
            ...
            if (content.length() > 0)
            {
                        ...
                        URL_COMMENT_WRITE, body, new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response)
                    {
                        ...
                        Log.v("comment_result", String.valueOf(result));
                    }
